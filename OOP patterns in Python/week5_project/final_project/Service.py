...
def apply_megapower(engine, hero):
    engine.hero = Objects.MegaPower(hero)
    engine.notify("Plus Ultra applied") # reference to anime "my hero academy"
...
def service_init(sprite_size, full=True):
    ...
    object_list_actions = {'reload_game': reload_game,
                           ...
                           'apply_megapower': apply_megapower}
